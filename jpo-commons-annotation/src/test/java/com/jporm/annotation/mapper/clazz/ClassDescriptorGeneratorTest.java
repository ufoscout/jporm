...
public class ClassDescriptorGeneratorTest extends BaseTestApi {
	...
	public void testBeanWithAutogeneratedFallbackSequenceValuesGenerator() {
		...
		final FieldDescriptor<BeanWithAutogeneratedFallback, Object, Object> field = classMapper.getFieldDescriptorByJavaName("autogeneratedFallbackField");
	...
	public void testBeanWithAutogeneratedValuesGenerator() {
		...
		assertNotNull(classMapper);
		final FieldDescriptor<BeanWithAutogenerated, Object, Object> field = classMapper.getFieldDescriptorByJavaName("autogeneratedField");
	...
	public void testBeanWithSequenceFallbackAutogeneratedValuesGenerator() {
		...
		assertNotNull(classMapper);
		final FieldDescriptor<BeanWithSequenceFallback, Object, Object> field = classMapper.getFieldDescriptorByJavaName("sequenceFallbackField");
	...
	public void testBeanWithSequenceValuesGenerator() {
		...
		assertNotNull(classMapper);
		final FieldDescriptor<BeanWithSequence, Object, Object> field = classMapper.getFieldDescriptorByJavaName("sequenceField");
	...
	public <P> void testClassDescriptorperGenerator1() {
		...
		for (final String col : classMapper.getPrimaryKeyColumnJavaNames()) {
			System.out.println("Search column " + col); //$NON-NLS-1$
			final FieldDescriptor<Employee, P, P> column = classMapper.getFieldDescriptorByJavaName(col);
	...
	public <P> void testClassDescriptorperGenerator2() {
		...
		for (final String col : classMapper.getPrimaryKeyColumnJavaNames()) {
			System.out.println("Search column " + col); //$NON-NLS-1$
			final FieldDescriptor<Blobclob_Stream, P, P> column = classMapper.getFieldDescriptorByJavaName(col);
			assertTrue(column.isIdentifier());
		}
	...
	public <P> void testClassDescriptorperGenerator3() {
		...
		for (final String col : classMapper.getPrimaryKeyColumnJavaNames()) {
			System.out.println("Search column " + col); //$NON-NLS-1$
			final FieldDescriptor<Blobclob_ByteArray, P, P> column = classMapper.getFieldDescriptorByJavaName(col);
			assertTrue(column.isIdentifier());
		}
	...
	public void testWitherMethods() {
		...
		final FieldDescriptor<EmployeeWithWitherAndOptional, Object, Object> idFieldDescriptor = classMapper.getFieldDescriptorByJavaName("id");
		assertEquals("id", idFieldDescriptor.getGetter().get().getName());
		assertEquals("setId", idFieldDescriptor.getSetter().get().getName());

		final FieldDescriptor<EmployeeWithWitherAndOptional, Object, Object> ageFieldDescriptor = classMapper.getFieldDescriptorByJavaName("age");
		assertEquals("getAge", ageFieldDescriptor.getGetter().get().getName());
		assertEquals("age", ageFieldDescriptor.getSetter().get().getName());

		final FieldDescriptor<EmployeeWithWitherAndOptional, Object, Object> surnameFieldDescriptor = classMapper.getFieldDescriptorByJavaName("surname");
		...
		assertEquals(String.class , surnameFieldDescriptor.getRealClass());
		assertEquals(String.class , surnameFieldDescriptor.getProcessedClass());
		assertTrue(surnameFieldDescriptor.getValueProcessor() instanceof NoOpsValueProcessor);

		final FieldDescriptor<EmployeeWithWitherAndOptional, Optional<?>, Object> nameFieldDescriptor = classMapper.getFieldDescriptorByJavaName("name");
		assertEquals("getName", nameFieldDescriptor.getGetter().get().getName());
		assertEquals("withName", nameFieldDescriptor.getSetter().get().getName());
		assertEquals(Optional.class , nameFieldDescriptor.getRealClass());
		assertEquals(String.class , nameFieldDescriptor.getProcessedClass());
		assertTrue(nameFieldDescriptor.getValueProcessor() instanceof OptionalValueProcessor);
