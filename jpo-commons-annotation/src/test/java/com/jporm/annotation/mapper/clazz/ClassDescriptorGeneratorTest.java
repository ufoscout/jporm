...
public class ClassDescriptorGeneratorTest extends BaseTestApi {
	...
	public void testBeanWithAutogeneratedFallbackSequenceValuesGenerator() {
		final ClassDescriptor<BeanWithAutogeneratedFallback> classMapper = new ClassDescriptorBuilderImpl<>(BeanWithAutogeneratedFallback.class, new TypeConverterFactory()).build();
	...
	public void testBeanWithAutogeneratedValuesGenerator() {
		final ClassDescriptor<BeanWithAutogenerated> classMapper = new ClassDescriptorBuilderImpl<>(BeanWithAutogenerated.class, new TypeConverterFactory()).build();
		assertNotNull(classMapper);
	...
	public void testBeanWithSequenceFallbackAutogeneratedValuesGenerator() {
		final ClassDescriptor<BeanWithSequenceFallback> classMapper = new ClassDescriptorBuilderImpl<>(BeanWithSequenceFallback.class, new TypeConverterFactory()).build();
		assertNotNull(classMapper);
	...
	public void testBeanWithSequenceValuesGenerator() {
		final ClassDescriptor<BeanWithSequence> classMapper = new ClassDescriptorBuilderImpl<>(BeanWithSequence.class, new TypeConverterFactory()).build();
		assertNotNull(classMapper);
	...
	public <P> void testClassDescriptorperGenerator1() {
		final ClassDescriptor<Employee> classMapper = new ClassDescriptorBuilderImpl<>(Employee.class, new TypeConverterFactory()).build();
		assertNotNull(classMapper);
	...
	public <P> void testClassDescriptorperGenerator2() {
		...
		final ClassDescriptor<Blobclob_Stream> classMapper = new ClassDescriptorBuilderImpl<>(Blobclob_Stream.class, new TypeConverterFactory()).build();
		assertNotNull(classMapper);
	...
	public <P> void testClassDescriptorperGenerator3() {
		...
		final ClassDescriptor<Blobclob_ByteArray> classMapper = new ClassDescriptorBuilderImpl<>(Blobclob_ByteArray.class, new TypeConverterFactory()).build();
		assertNotNull(classMapper);
	...
	public void testWitherMethods() {
		...
		final ClassDescriptor<EmployeeWithWither> classMapper = new ClassDescriptorBuilderImpl<>(EmployeeWithWither.class, new TypeConverterFactory()).build();
		assertNotNull(classMapper);
