...
public class ClassDescriptorGeneratorTest extends BaseTestApi {
	...
	public void testWitherMethods() {
		...
		final ClassDescriptor<EmployeeWithWither> classMapper = new ClassDescriptorBuilderImpl<>(EmployeeWithWither.class).build();
		assertNotNull(classMapper);
		...
		final FieldDescriptor<EmployeeWithWither, Object> ageFieldDescriptor = classMapper.getFieldDescriptorByJavaName("age");
