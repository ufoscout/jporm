...
public class ClassDescriptorGeneratorTest extends BaseTestApi {
    ...
    public void testBeanWithAutogeneratedValuesGenerator() {
        final ClassDescriptor<BeanWithAutogenerated> classMapper = new ClassDescriptorBuilderImpl<BeanWithAutogenerated>(BeanWithAutogenerated.class,
    ...
    public void testBeanWithSequenceFallbackAutogeneratedValuesGenerator() {
        final ClassDescriptor<BeanWithSequenceFallback> classMapper = new ClassDescriptorBuilderImpl<BeanWithSequenceFallback>(BeanWithSequenceFallback.class,
                new TypeConverterFactory()).build();
        assertNotNull(classMapper);
    ...
    public void testBeanWithSequenceValuesGenerator() {
        final ClassDescriptor<BeanWithSequence> classMapper = new ClassDescriptorBuilderImpl<BeanWithSequence>(BeanWithSequence.class,
                new TypeConverterFactory()).build();
        assertNotNull(classMapper);
    ...
    public <P> void testClassDescriptorperGenerator1() {
        final ClassDescriptor<Employee> classMapper = new ClassDescriptorBuilderImpl<Employee>(Employee.class, new TypeConverterFactory()).build();
        assertNotNull(classMapper);
    ...
    public <P> void testClassDescriptorperGenerator2() {
        ...
        final ClassDescriptor<Blobclob_Stream> classMapper = new ClassDescriptorBuilderImpl<Blobclob_Stream>(Blobclob_Stream.class, new TypeConverterFactory())
                .build();
        assertNotNull(classMapper);
    ...
    public <P> void testClassDescriptorperGenerator3() {
        ...
        final ClassDescriptor<Blobclob_ByteArray> classMapper = new ClassDescriptorBuilderImpl<Blobclob_ByteArray>(Blobclob_ByteArray.class,
                new TypeConverterFactory()).build();
        assertNotNull(classMapper);
