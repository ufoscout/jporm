...
public interface DBFeatures {
    ...
    /**
     * Whether the DB correctly returns the number of updated rows in a batchUpdate operation.
     * Databases like Oracle, for example, instead of returning the number of updated rows, return
     * the code "-2" indicating that the operation was executed successfully; in such a case,
     * there is no way of knowing the number of updated rows and this method returns false.
     * @return
     */
