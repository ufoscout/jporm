...
/**
 * This interface is used as a marker to identify Extended {@link TypeConverterWrapper}
 ...
 * @param <DB>
 */
public interface TypeConverterWrapper<P, DB, W> extends TypeConverter<P, DB> {
