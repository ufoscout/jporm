...
/**
 * This interface is used as a marker to identify Extended {@link TypeConverter}s.
 * A converter for a specific type. This can be used to create custom converter from a desired type to
