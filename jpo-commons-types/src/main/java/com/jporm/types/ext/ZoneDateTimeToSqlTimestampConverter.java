 ...
 * Mar 27, 2012
 */
public class ZoneDateTimeToSqlTimestampConverter implements TypeConverter<ZonedDateTime, Timestamp> {
	...
	@Override
	public ZonedDateTime fromJdbcType(final Timestamp value) {
		if (value==null) {
			return null;
		}
	...
	@Override
	public Timestamp toJdbcType(final ZonedDateTime value) {
		if (value==null) {
			return null;
		}
