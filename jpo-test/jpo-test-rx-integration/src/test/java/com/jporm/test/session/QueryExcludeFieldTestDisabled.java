 ...
 * 20/mag/2011
 */
//THIS TEST IS DISABLED BECAUSE IT REQUIRES THE saveOrUpdate and the deleteQuery
@Ignore
public class QueryExcludeFieldTestDisabled extends BaseTestAllDB {

	public QueryExcludeFieldTestDisabled(final String testName, final TestData testData) {
