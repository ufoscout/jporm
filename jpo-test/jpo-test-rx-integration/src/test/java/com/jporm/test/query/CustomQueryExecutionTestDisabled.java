 ...
 */
@Ignore
public class CustomQueryExecutionTestDisabled extends BaseTestAllDB {

	public CustomQueryExecutionTestDisabled(final String testName, final TestData testData) {
