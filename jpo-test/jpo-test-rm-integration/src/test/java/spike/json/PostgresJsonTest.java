...
public class PostgresJsonTest  extends BaseTestAllDB {

	private final ObjectMapper mapper = new ObjectMapper();

	public PostgresJsonTest(final String testName, final TestData testData) {
		super(testName, testData);
	}

	@Test
	public void testSqlJsonCRUD() throws Exception {
