...
public class CustomQueryExecutionTest extends BaseTestAllDB {
	...
	public void testOrderByAsc() {
		...
		final List<String> results = session.find("emp.id", "emp.employeeNumber", "emp2.employeeNumber").from(Employee.class, "emp").join(Employee.class, "emp2") //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
