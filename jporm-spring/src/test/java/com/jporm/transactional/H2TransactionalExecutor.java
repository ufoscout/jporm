...
public class H2TransactionalExecutor implements ITransactionalExecutor {
	...
	@Override
	@Transactional (value="h2TransactionManager", rollbackFor=Throwable.class)
	...
	@Override
	@Transactional (value="h2TransactionManager", rollbackFor=Throwable.class, isolation=Isolation.SERIALIZABLE)
	...
	@Override
	@Transactional (value="h2TransactionManager", rollbackFor=MyException.class)
