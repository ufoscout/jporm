...
@Suspendable
public class CustomFindQueryGroupBySyncImpl extends CustomFindQueryCommonSyncAbstract implements CustomFindQueryGroupBySync {

	private final CustomFindQueryGroupBy groupBy;
	private final CustomFindQuerySync customFindQuerySync;
	private final CustomFindQuery customFindQuery;

	public CustomFindQueryGroupBySyncImpl(CustomFindQuerySync customFindQuerySync, CustomFindQuery customFindQuery, CustomFindQueryGroupBy groupBy) {
	...
	@Override
	public CustomFindQueryGroupBySync having(String havingClause, Object... args) {
		groupBy.having(havingClause, args);
		return this;
	}

	@Override
	public CustomFindQueryGroupBySync fields(String... fields) {
