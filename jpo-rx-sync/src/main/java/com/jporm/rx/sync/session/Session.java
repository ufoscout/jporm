...
public interface Session {
	 ...
	 * @return
	 */
	<BEAN> DeleteResult delete(BEAN bean) throws JpoException;
...
//	 * @return
//	 */
//	<BEAN> DeleteResult> delete(Collection<BEAN> beans) throws JpoException;
...
//	<BEAN> List<BEAN> update(Collection<BEAN> beans) throws JpoException;
	 ...
	 * @throws JpoException
	 */
	<BEAN> BEAN saveOrUpdate(BEAN bean);
