...
public class FindQueryOrm<BEAN> extends SmartRenderableSqlQuery implements FindQuery<BEAN> {
    ...
    public FindQueryOrm(final ServiceCatalog serviceCatalog, final Class<BEAN> clazz, final String alias) {
        ...
        this.select = new CustomFindSelectImpl(serviceCatalog.getOrmClassTool(clazz).getClassMap().getAllColumnJavaNames());
    ...
    @Override
    public FindQuery<BEAN> lazy(final boolean lazy) {
        this._lazy = lazy;
        return this;
    }
    ...
    @Override
    public FindWhere<BEAN> where(final ExpressionElement... expressionElements) {
    ...
    @Override
    public FindWhere<BEAN> where(final List<ExpressionElement> expressionElements) {
        where.and(expressionElements);
        return where;
    }
