 ...
 * 13/giu/2011
 */
public class CustomColumnValueGenerator extends AColumnValueGenerator {

    private ValueGenerator<?> generator;

    public CustomColumnValueGenerator(final String name, final DBProfile dbProfile, ValueGenerator<?> generator) {
