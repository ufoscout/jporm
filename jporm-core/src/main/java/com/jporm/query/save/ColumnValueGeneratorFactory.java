...
import com.jporm.util.ClassUtil;
    ...
    public static <BEAN> AColumnValueGenerator getColumnValueGenerator(final ClassField<BEAN,? extends Object> classField, final DBProfile dbProfile, final boolean ignoreGenerator) {
        ...
        if (!ignoreGenerator) {
            ...
            case AUTOGENERATED_FALLBACK_SEQUENCE:
                ...
                break;
            case CUSTOM:
                Class<? extends ValueGenerator<?>> valueClass = classField.getGeneratorInfo().getValueGeneratorClass();
                if (valueClass==null) {
                    throw new OrmConfigurationException("When @Generator.CUSTOM is used, the valueGeneratorClass is mandatory. Please provide one.");
                }
                columnValueGenerator = new CustomColumnValueGenerator(classField.getGeneratorInfo().getName(), dbProfile, ClassUtil.newInstance(valueClass));
                break;
            case NONE:
                break;
            }
