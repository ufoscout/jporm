...
public class GeneratorInfoFactory {
    ...
    public static GeneratorInfo getGeneratorInfo(final Field field) {
        ...
        if (generator!=null) {
            return new GeneratorInfoImpl(generator.generatorType(), generator.name(), true, generator.valueGeneratorClass());
        }
        return new GeneratorInfoImpl(GeneratorType.NONE, ObjectBuilder.EMPTY_STRING, false, null); 
    }
