...
public class ValueCheckerFactory {
    ...
    public static <P> ValueChecker<P> getValueChecker(final Class<P> clazz) {
        ...
        throw new OrmConfigurationException("Cannot use type " + clazz + " for a field annotated as Generated. Valid classes are [" + MapUtil.keysToString(VALUE_CHECKERS) + "]" ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    }
