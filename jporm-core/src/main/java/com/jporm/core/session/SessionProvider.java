...
public abstract class SessionProvider {
	...
	public abstract <T> T doInTransaction(TransactionalSession session, TransactionDefinition transactionDefinition, TransactionCallback<T> transactionCallback);
