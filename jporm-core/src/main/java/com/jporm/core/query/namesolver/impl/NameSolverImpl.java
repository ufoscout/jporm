 ...
 ******************************************************************************/
package com.jporm.core.query.namesolver.impl;
...
import com.jporm.core.exception.JpoQueryFormatException;
import com.jporm.core.inject.ClassTool;
import com.jporm.core.inject.ServiceCatalog;
import com.jporm.core.query.Property;
...
public class NameSolverImpl implements NameSolver {
	...
	public String solvePropertyName(final String propertyName) throws JpoException {
		...
		if (!registeredClass.containsKey(alias)) {
			throw new JpoException("Alias [" + alias + "] is not associated with an Orm Entity. Registered alias are: " + registeredClass.keySet()); //$NON-NLS-1$ //$NON-NLS-2$
		}
	...
	@Override
	public <P> Integer register(final Class<P> clazz, final String alias) throws JpoException {
	...
	private <P> Integer register(final Class<P> clazz, final String alias, final ClassTool<P> ormClassTool) throws JpoException {
