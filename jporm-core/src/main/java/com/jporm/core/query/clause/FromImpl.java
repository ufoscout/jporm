...
import com.jporm.core.query.clause.from.JoinElement;
import com.jporm.core.query.clause.from.LeftOuterJoinElement;
import com.jporm.core.query.clause.from.NaturalJoinElement;
import com.jporm.core.query.clause.from.RightOuterJoinElement;
import com.jporm.query.clause.From;
...
public abstract class FromImpl<T extends From<?>> extends SmartRenderableSqlSubElement implements From<T> {
    ...
    public final void renderSqlElement(final StringBuilder queryBuilder, final NameSolver localNameSolver) {
        ...
        queryBuilder.append(this.serviceCatalog.getOrmClassTool(this.clazz).getClassMap().getTableInfo().getTableNameWithSchema() );
