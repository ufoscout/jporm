...
import com.jporm.sql.dialect.sqlserver2008.SQLServer2008_DBProfile;
...
public enum DBType {
    ...
    UNKNOWN(new UnknownDBProfile()), DERBY(new DerbyDBProfile()), H2(new H2DBProfile()), HSQLDB(new HSQLDB2DBProfile()), MYSQL(new MySqlDBProfile()), ORACLE(
            new Oracle10gDBProfile()), POSTGRESQL(new PostgresDBProfile()), SQLSERVER2008(new SQLServer2008_DBProfile());
