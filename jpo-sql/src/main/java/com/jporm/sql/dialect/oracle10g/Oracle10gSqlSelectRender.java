...
public class Oracle10gSqlSelectRender implements SqlSelectRender, SqlFromRender, SqlOrderByRender, SqlGroupByRender, SqlWhereRender {

    private final SqlPaginationRender paginationRender = new Oracle10gSqlPaginationRender();
