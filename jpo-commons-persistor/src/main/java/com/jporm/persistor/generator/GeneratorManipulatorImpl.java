...
public class GeneratorManipulatorImpl<BEAN, P> extends GeneratorManipulator<BEAN> {
	...
	private BiFunction<BEAN, P, P> preElaborateField = (t, u) -> {return u;};

    public GeneratorManipulatorImpl(final PropertyPersistor<BEAN, P, ?> fieldManipulator, GeneratorInfo generatorInfo) throws SecurityException {
