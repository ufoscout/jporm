...
import com.jporm.domain.AllAnnotationsBean;
...
public class ReflectionAllAnnotationsBeanPersistorGeneratorTest extends BaseTestApi {
    ...
    public void setUp() throws Exception {
        ...
        classMapper = jpo.getServiceCatalog().getOrmClassTool(AllAnnotationsBean.class).getClassMap();
        persistor = jpo.getServiceCatalog().getOrmClassTool(AllAnnotationsBean.class).getOrmPersistor();
