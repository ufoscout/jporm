...
public class ExpressionTest extends BaseTestApi {
    ...
    public void testExpression2() {
        ...
        final ExpressionElement expressionOne = new InExpressionElement( "prop1", new Object[]{"hello1","hello2","hello3","hello4"}); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
        final ExpressionElement expressionTwo = new NInExpressionElement( "prop2", new Object[]{"hello5","hello6","hello7","hello8"} ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
