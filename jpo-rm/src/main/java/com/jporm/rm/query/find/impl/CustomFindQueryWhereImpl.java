 ...
 * @author ufo
 */
public class CustomFindQueryWhereImpl extends CommonFindQueryWhereImpl<CustomFindQuery, CustomFindQueryWhere, CustomFindQueryOrderBy>
        implements CustomFindQueryWhere {

    public CustomFindQueryWhereImpl(final com.jporm.sql.query.clause.Where sqlWhere, final CustomFindQuery customFindQuery) {
