...
public class SqlExecutorsTest extends BaseTestApi {
    ...
    private List<Long> sqlExecutorInsert(final SqlExecutor sqlExec) {
        ...
        assertEquals(1,
                sqlExec.update(sqlKeyExtractor, new Object[] { "sqlExec.update(sqlKeyExtractor, generatedKeyExtractor, args", "1" }, generatedKeyExtractor).intValue()); //$NON-NLS-1$ //$NON-NLS-2$
