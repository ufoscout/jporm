...
public interface SqlSubElement extends Sql {
     ...
     * @return
     */
    String renderSqlElement(DBProfile dbprofile, NameSolver nameSolver);
     ...
     * @param queryBuilder
     */
    void renderSqlElement(DBProfile dbprofile, StringBuilder queryBuilder, NameSolver nameSolver);
