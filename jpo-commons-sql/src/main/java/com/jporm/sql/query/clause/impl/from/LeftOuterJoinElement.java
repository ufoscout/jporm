...
public class LeftOuterJoinElement<BEAN> extends AFromElement<BEAN> {
    ...
    public LeftOuterJoinElement(final ClassDescriptor<BEAN> classDescriptor, final Class<?> joinClass, final Integer nameSolverClassId) {
        this(classDescriptor, joinClass, nameSolverClassId, "", ""); //$NON-NLS-1$ //$NON-NLS-2$
        onClause = false;
    }

    public LeftOuterJoinElement(final ClassDescriptor<BEAN> classDescriptor, final Class<?> joinClass, final Integer nameSolverClassId, final String onLeftProperty, final String onRigthProperty) {
