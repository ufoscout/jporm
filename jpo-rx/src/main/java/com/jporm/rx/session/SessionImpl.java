...
public class SessionImpl implements Session {
	...
	public SessionImpl(final ServiceCatalog serviceCatalog, DBProfile dbProfile, final AsyncConnectionProvider<? extends AsyncConnection> connectionProvider, SqlCache sqlCache,
		...
		dbType = dbProfile;
		sqlSession = new SqlSessionImpl(new SqlExecutorImpl(serviceCatalog.getTypeFactory(), connectionProvider), sqlFactory.getSqlDsl());
	}
	...
	public <BEAN> CompletableFuture<BEAN> save(final BEAN bean) {
		try {
			...
			final CompletableFuture<BEAN> validate = new CompletableFuture<BEAN>();
