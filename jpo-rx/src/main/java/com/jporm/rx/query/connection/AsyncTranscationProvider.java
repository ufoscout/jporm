...
public interface AsyncTranscationProvider {
	 ...
	 */
	AsyncTransaction getTransaction(ServiceCatalog serviceCatalog, SqlCache sqlCache, SqlFactory sqlFactory);
	...
	AsyncConnectionProvider<? extends AsyncConnection> getConnectionProvider();
