...
import com.jporm.rx.rxjava2.query.update.UpdateResult;
...
public class SqlExecutorImplTest extends BaseTestApi {
	...
	public void setUp() {
		sqlExecutor =
				new com.jporm.rx.rxjava2.session.SqlExecutorImpl(new TypeConverterFactory(() -> new Jackson2JsonService()), getConnectionProvider(conn));
